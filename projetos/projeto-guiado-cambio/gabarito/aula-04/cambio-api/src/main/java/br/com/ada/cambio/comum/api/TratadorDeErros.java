...
public class TratadorDeErros {
    ...
    /** Provedor de cotação fora do ar ou com resposta inesperada → 503. */
    @ExceptionHandler(CotacaoIndisponivelException.class)
    public ResponseEntity<RespostaDeErro> tratarCotacaoIndisponivel(CotacaoIndisponivelException excecao) {
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(RespostaDeErro.de(HttpStatus.SERVICE_UNAVAILABLE.value(), excecao.getMessage()));
    }
