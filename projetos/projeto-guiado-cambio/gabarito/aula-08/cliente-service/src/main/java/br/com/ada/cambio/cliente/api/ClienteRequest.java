...
import br.com.ada.cambio.cliente.dominio.RegrasDeCliente;
...
public record ClienteRequest(
        ...
        @Size(max = RegrasDeCliente.TAMANHO_MAXIMO_NOME, message = "nome deve ter no maximo 120 caracteres")
        String nome,

        @NotBlank(message = "cpf e obrigatorio")
        @Pattern(regexp = RegrasDeCliente.PADRAO_CPF, message = "cpf deve conter exatamente 11 digitos")
        String cpf,
